...
elif selected_task == 'Main Page':
    uploaded_file = st.file_uploader('Upload a file', type=['csv', 'xlsx'])
    # uploaded_file = "C:/Users/arpit/My_PC/repos/SwiftML/SwiftML/assets/dataset/spg.csv"
    
    st.multiselect('Select Tasks', ['Data Preprocessing', 'Model Selection', 'Model Training', 'Model Evaluation', 'Save Model Locally','Model Deployment'])
